...
func ExecuteTurn(ctx context.Context, command RunnerCommand, opened *store.Store, scope store.RunScope, processes *ProcessSet, logPath string, runtimeLimit *time.Duration) TurnExecution {
	if processes == nil {
